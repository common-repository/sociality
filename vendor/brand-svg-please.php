...
if ( ! class_exists( 'Brand_SVG_Please' ) ) :
    ...
    class Brand_SVG_Please {
        ...
        public static function get_all_brands( $get_svg = false, $svg_data = array() ) {
            $brands = array(
                '42-group'                  => esc_html__( '42 Group', 'sociality' ),
                ...
                'affiliatetheme'            => esc_html__( 'Affiliate Theme', 'sociality' ),
                ...
                'app-store-ios'             => esc_html__( 'App Store iOS', 'sociality' ),
                ...
                'bilibili'                  => esc_html__( 'Bilibili', 'sociality' ),
                ...
                'bots'                      => esc_html__( 'Bots', 'sociality' ),
                'brave'                     => esc_html__( 'Brave', 'sociality' ),
                ...
                'cloudflare'                => esc_html__( 'Cloudflare', 'sociality' ),
                ...
                'cmplid'                    => esc_html__( 'Cmplid://', 'sociality' ),
                ...
                'debian'                    => esc_html__( 'Debian', 'sociality' ),
                'deezer'                    => esc_html__( 'Deezer', 'sociality' ),
                ...
                'instalod'                  => esc_html__( 'InstaLOD', 'sociality' ),
                ...
                'letterboxd'                => esc_html__( 'Letterboxd', 'sociality' ),
                ...
                'padlet'                    => esc_html__( 'Padlet', 'sociality' ),
                ...
                'perbyte'                   => esc_html__( 'PerByte', 'sociality' ),
                ...
                'pix'                       => esc_html__( 'PIX', 'sociality' ),
                'pixiv'                     => esc_html__( 'Pixiv', 'sociality' ),
                'playstation'               => array(
                ...
                'qq'                        => array(
                    'name' => esc_html__( 'Tencent QQ', 'sociality' ),
                ...
                'rust'                      => esc_html__( 'Rust', 'sociality' ),
                ...
                'screenpal'                 => esc_html__( 'ScreenPal', 'sociality' ),
                ...
                'sitrox'                    => esc_html__( 'Sitrox', 'sociality' ),
                ...
                'stubber'                   => esc_html__( 'Stubber', 'sociality' ),
                ...
                'threads'                   => esc_html__( 'Threads', 'sociality' ),
                ...
                'watchman-monitoring'       => esc_html__( 'Watchman Monitoring', 'sociality' ),
                ...
                'wirsindhandwerk'           => esc_html__( 'wirsindhandwerk', 'sociality' ),
                'wizards-of-the-coast'      => esc_html__( 'Wizards of the Coast', 'sociality' ),
                'wodu'                      => esc_html__( 'Wodu.', 'sociality' ),
                ...
                'x-twitter'                 => array(
                    'name' => esc_html__( 'X / Twitter', 'sociality' ),
                ...
                'yandex-international'      => esc_html__( 'Yandex International', 'sociality' ),
